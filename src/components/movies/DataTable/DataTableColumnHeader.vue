...
import { ArrowDownIcon, ArrowUpIcon, ArrowDownUpIcon } from 'lucide-vue-next'

interface DataTableColumnHeaderProps {
  column: Column<MovieWithRating, any>
  title: string
}
  ...
  <div v-if="column.getCanSort()" :class="cn('flex items-center space-x-2', $attrs.class ?? '')">
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start">
        ...
        <DropdownMenuItem @click="column.clearSorting"> Reset </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  </div>
